...
class TriviaTestCase(unittest.TestCase):
        ...
        res = self.client().post(
            ...
            headers={
                "Authorization": "Bearer {}".format(
                    self.userTokens['executiveproducer']
                )
            }
        )
    ...
    def test_get_movies_as_assistant(self):
        res = self.client().get(
            ...
            headers={
                "Authorization": "Bearer {}".format(
                    self.userTokens['castingassistant']
                )
            }
        )
        self.assertEqual(res.status_code, 200)
    ...
    def test_get_movies_as_director(self):
        res = self.client().get(
            ...
            headers={
                "Authorization": "Bearer {}".format(
                    self.userTokens['castindirector']
                )
            }
        )
        self.assertEqual(res.status_code, 200)
    ...
    def test_create_movie_as_director(self):
        res = self.client().post(
            '/movies',
            json=self.new_movie_as_director,
            headers={
                "Authorization": "Bearer {}".format(
                    self.userTokens['castindirector']
                )
    ...
    def test_create_actor_as_director(self):
        res = self.client().post(
            '/actors',
            json=self.new_actor_as_director,
            headers={
                "Authorization": "Bearer {}".format(
                    self.userTokens['castindirector']
                )
